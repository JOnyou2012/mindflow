...
const t = {
  ...
  en: {
    ...
    gcalClippedTimeNote: 'This event extends outside 6:00–22:00, so only the title is saved here — edit its real times in Google Calendar.',
  ...
  'zh-CN': {
    ...
    gcalExportSkipped: '{n} 个已跳过',
    gcalExportFailed: '{n} 个失败',
    saveImage: '保存为图片',
    saveImageError: '无法保存图片。请重试。',
    gcalUnsync: '移除',
    ...
    gcalClippedTimeNote: '此事件超出 6:00–22:00 范围，此处仅保存标题 — 请在 Google 日历中修改实际时间。',
    ariaPrevWeek: '上一周',
    ariaNextWeek: '下一周',
    ariaClose: '关闭',
    stroopSlow: '慢',
  ...
  'zh-TW': {
    ...
    gcalExportSkipped: '{n} 個已略過',
    gcalExportFailed: '{n} 個失敗',
    saveImage: '儲存為圖片',
    saveImageError: '無法儲存圖片。請重試。',
    gcalUnsync: '移除',
    ...
    gcalClippedTimeNote: '此事件超出 6:00–22:00 範圍，此處僅儲存標題 — 請在 Google 日曆中修改實際時間。',
    ariaPrevWeek: '上一週',
    ariaNextWeek: '下一週',
    ariaClose: '關閉',
    stroopSlow: '慢',
  ...
  es: {
    ...
    gcalClippedTimeNote: 'Este evento se extiende fuera de 6:00–22:00, así que aquí solo se guarda el título — edita su horario real en Google Calendar.',
  ...
  hi: {
    ...
    gcalExportSkipped: '{n} छोड़े गए',
    gcalExportFailed: '{n} विफल',
    saveImage: 'छवि के रूप में सहेजें',
    saveImageError: 'छवि सहेज नहीं सके। कृपया पुनः प्रयास करें।',
    gcalUnsync: 'हटाएं',
    ...
    gcalClippedTimeNote: 'यह इवेंट 6:00–22:00 से बाहर है, इसलिए यहाँ केवल शीर्षक सहेजा जाता है — असली समय Google Calendar में संपादित करें।',
  ...
  ar: {
    ...
    gcalExportSkipped: 'تم تخطي {n}',
    gcalExportFailed: 'فشل {n}',
    saveImage: 'حفظ كصورة',
    saveImageError: 'تعذّر حفظ الصورة. حاول مرة أخرى.',
    gcalUnsync: 'إزالة',
    ...
    gcalClippedTimeNote: 'يمتد هذا الحدث خارج 6:00–22:00، لذا يُحفظ العنوان فقط هنا — عدّل أوقاته الفعلية في تقويم Google.',
